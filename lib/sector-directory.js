...
export const DIRECTORY = [
  // ── Tech, Software & AI ───────────────────────────────────────────────────
  {
    ...
    names: ['software'],
    companies: [
      'microsoft', 'google', 'meta$', 'apple$', 'linkedin', 'salesforce', 'oracle$', 'adobe$', 'sap$', 'servicenow', 'workday',
      'atlassian', 'hubspot',
  ...
  },
  {
    ...
    names: ['ai'],
    companies: [
      'openai', 'open ai', 'anthropic', 'cohere$', 'mistral$', 'hugging face', 'huggingface',
  ...
  },
  {
    ...
    companies: [
      ...
      'ameriprise', 'raymond james', 'lpl financial', 'northwestern mutual', 'pimco', 't rowe price',
      'franklin templeton', 'invesco', 'capital group', 'wellington management', 'nuveen', 'bridgewater$', 'bridgewater associates',
      'citadel$',
      'citadel securities', 'two sigma', 'de shaw', 'd e shaw', 'renaissance technologies', 'millennium management', 'point72',
      'jane street', 'hudson river trading', 'jump trading', 'optiver', 'susquehanna international', 'virtu financial', 'drw$', 'aqr',
      'man group',
  ...
  },
  {
    ...
    companies: [
      ...
      'elevance', 'centene', 'molina healthcare', 'blue cross', 'bcbs', 'marsh$', 'marsh mclennan', 'aon$',
  ...
  // ── Healthcare & Biotech ──────────────────────────────────────────────────
  {
    ...
    companies: [
      'kaiser permanente', 'hca$', 'hca healthcare', 'tenet healthcare', 'commonspirit', 'ascension$', 'ascension health',
      'providence health', 'trinity health', 'mass general', 'massachusetts general', 'mount sinai', 'nyu langone',
      'johns hopkins medicine', 'ucla health', 'stanford health', 'memorial sloan kettering', 'md anderson', 'dana farber',
      'cedars sinai', 'city of hope', 'one medical', 'oak street health', 'carbon health', 'teladoc',
  ...
  {
    key: 'veterinary', label: 'Veterinary & Animal Care', group: 'health', kind: 'industry',
    words: [
      'veterinary', 'veterinarian(s)', 'veterinary medicine', 'veterinary technician(s)', 'veterinary assistant(s)', 'vet tech(s)',
      'vet assistant(s)', 'vet clinic(s)', 'vet hospital(s)', 'emergency vet', 'dvm', 'animal hospital(s)', 'animal clinic(s)',
      'pet hospital(s)', 'animal care', 'animal shelter(s)', 'animal rescue', 'animal welfare', 'animal control', 'pet care',
      'pet grooming', 'pet groomer(s)', 'dog groomer(s)', 'groomer(s)', 'dog trainer(s)', 'dog training', 'pet sitter(s)', 'pet sitting',
      'dog walker(s)', 'kennel(s)', 'doggy daycare', 'zookeeper(s)', 'zoo(s)', 'aquarium(s)', 'equine', 'farrier(s)',
      'animal behaviorist(s)',
    ],
    companies: [
      'banfield', 'vca$', 'vca animal hospitals', 'bluepearl', 'mars veterinary health', 'national veterinary associates',
      'thrive pet healthcare', 'heartland veterinary partners', 'petvet care centers', 'idexx', 'elanco', 'aspca',
      'humane society', 'best friends animal society', 'rover$', 'trupanion', 'american veterinary medical association',
    ],
    not: [...HOBBY],
  },
  ...
  // ── Education ─────────────────────────────────────────────────────────────
  {
    ...
    words: [
      ...
      'homeschool', 'tutor(s)', 'tutoring', 'intermediate school(s)', 'preparatory school(s)', 'prep school(s)',
    ],
    // In a company's name only: "Oak Elementary" is a school, and a headline's
    // "elementary" is as often something else.
    names: ['elementary'],
    companies: [
  ...
  },
  {
    ...
    companies: [
      ...
      'georgia institute of technology', 'virginia tech', 'texas a&m', 'ucla$', 'uc berkeley', 'uc davis', 'uc san diego', 'uc irvine',
      'purdue$', 'purdue global', 'rutgers', 'cornell$', 'yale$', 'princeton$',
      'harvard$', 'harvard business school', 'harvard law school', 'harvard medical school', 'harvard kennedy school', 'stanford$',
      'stanford gsb', 'penn state', 'ohio state$', 'arizona state$', 'georgetown$', 'vanderbilt$', 'emory$', 'tulane$',
    ...
    // "College Park" is a place; a credit union named after a university is a
    // bank, and a hospital named for one (University Health) is a hospital.
    not: ['college park', 'college hunks', 'credit union(s)', 'university health', 'health system(s)', 'hospital(s)', 'medical center(s)'],
  },
  ...
  // ── Marketing & Media ─────────────────────────────────────────────────────
  {
    ...
    companies: [
      ...
      'the trade desk', 'mediamonks', 'media monks', 'monks$', 'razorfish', 'digitas',
  ...
  },
  {
    ...
    companies: [
      ...
      'bustle', 'the athletic$', 'bloomberg$', 'reuters', 'thomson reuters', 'associated press', 'cnn$', 'msnbc', 'cbs news', 'abc news',
      'npr$', 'national public radio', 'bbc', 'the guardian$', 'the economist', 'financial times', 'forbes$',
    ...
    // Newport News builds ships, and good news is a church's.
    not: ['video editor(s)', 'photo editor(s)', 'film editor(s)', 'newport news', 'good news'],
  },
  {
    ...
    companies: [
      'youtube', 'tiktok', 'bytedance', 'snap$', 'patreon', 'substack', 'twitch$', 'linktree',
  ...
  // ── Entertainment & Gaming ────────────────────────────────────────────────
  {
    ...
    companies: [
      ...
      'paramount global', 'paramount pictures', 'paramount skydance',
      'nbcuniversal', 'nbc universal', 'universal music', 'umg$', 'sony$', 'lionsgate', 'mgm$',
      ...
      'wme$', 'william morris endeavor', 'united talent agency', 'def jam', 'interscope', 'bmg$', 'ascap', 'recording academy',
  ...
  },
  {
    ...
    companies: [
      ...
      'ubisoft', 'nintendo', 'playstation', 'xbox', 'take two', 'rockstar games', '2k$', '2k games',
  ...
  },
  {
    ...
    companies: [
      ...
      'major league soccer', 'espn', 'cbs sports', 'turner sports', 'dazn', 'the athletic$', 'bleacher report',
  ...
  // ── Retail, Consumer & Hospitality ────────────────────────────────────────
  {
    ...
    companies: [
      ...
      'albertsons', 'safeway', 'whole foods', 'trader joes', 'aldi$', 'walgreens', 'cvs health', 'macys',
      ...
      'dicks sporting goods', 'academy sports', 'sams club', '7 eleven', 'circle k', 'office depot', 'whatnot', 'poshmark', 'depop',
      'stockx', 'bigcommerce', 'woocommerce',
    ],
  ...
  },
  {
    ...
    companies: [
      ...
      'levis$', 'ralph lauren', 'tapestry$', 'michael kors', 'pvh$', 'tommy hilfiger', 'calvin klein', 'hanesbrands', 'vf$',
      ...
      'keurig dr pepper', 'tyson foods', 'conagra', 'campbell$', 'hormel', 'smucker', 'j m smucker', 'post holdings', 'danone',
  ...
  },
  {
    ...
    companies: [
      ...
      'us foods', 'aramark', 'compass group', 'sodexo', 'gordon food service', 'doordash', 'grubhub', 'opentable',
  ...
  },
  {
    ...
    words: [
      ...
      'tour guide(s)', 'cruises', 'cruise line(s)', 'cruise ship(s)', 'cruise director(s)', 'airline(s)', 'flight attendant(s)',
      'airline pilot(s)',
    ...
    companies: [
      ...
      'carnival corporation', 'royal caribbean', 'norwegian cruise line', 'universal destinations', 'universal parks', 'seaworld',
      'united parks', 'six flags',
  ...
  {
    key: 'beauty-personal-care', label: 'Beauty & Personal Care', group: 'consumer', kind: 'industry',
    // Salons, barbers and spas: the services. Beauty brands are Consumer Goods.
    words: [
      'salon(s)', 'hair salon(s)', 'nail salon(s)', 'beauty salon(s)', 'salon owner(s)', 'hair stylist(s)', 'hairstylist(s)',
      'hairdresser(s)', 'barber(s)', 'barbershop(s)', 'barber shop(s)', 'master barber(s)', 'esthetician(s)', 'aesthetician(s)',
      'cosmetologist(s)', 'cosmetology', 'nail technician(s)', 'nail tech(s)', 'manicurist(s)', 'lash artist(s)', 'lash technician(s)',
      'lash extensions', 'brow artist(s)', 'microblading', 'makeup artist(s)', 'med spa(s)', 'medspa(s)', 'medical spa(s)', 'day spa(s)',
      'beauty school(s)', 'skin care specialist(s)', 'skincare specialist(s)', 'hair removal', 'tanning salon(s)', 'spray tan',
    ],
    companies: [
      'great clips', 'supercuts', 'sport clips', 'fantastic sams', 'regis$', 'drybar', 'european wax center',
      'sola salon studios', 'sola salons', 'ideal image', 'hand & stone', 'massage envy', 'the lash lounge',
    ],
    // Salon the magazine, and companies named for a Barber.
    not: ['salon com', 'salon media', 'barber foods', 'barber motorsports', 'barber nichols', ...HOBBY],
  },
  ...
  // ── Manufacturing, Energy & Logistics ─────────────────────────────────────
  {
    ...
    words: [
      ...
      'third party logistics', 'transportation management', 'freight forwarding', 'freight forwarder(s)', 'customs broker(s)',
  ...
  },
  {
    ...
    companies: [
      ...
      'itw$', 'dover$', 'cummins$', 'cummins inc', 'paccar', 'dow$', 'dow chemical', 'dupont$', 'dupont de nemours', 'basf',
      ...
      'kohler$', 'stanley black & decker', 'milwaukee tool', 'bosch', 'abb$', 'schneider electric', 'mitsubishi$',
      'hitachi', 'komatsu', 'trane', 'carrier global', 'lennox$', 'lennox international', 'johnson controls', 'westinghouse',
    ],
  },
  {
    ...
    companies: [
      ...
      'enterprise products', 'southern company', 'edison international', 'entergy', 'aep$',
      'american electric power', 'exelon', 'sunrun', 'sunpower', 'sunnova', 'enphase', 'orsted', 'ørsted', 'vestas', 'siemens gamesa',
      'ge vernova', 'brookfield renewable', 'invenergy', 'avangrid', 'plug power',
    ],
  ...
  },
  {
    ...
    companies: [
      ...
      'kia motors', 'bmw', 'mercedes benz', 'volkswagen', 'audi$', 'porsche', 'volvo', 'subaru', 'mazda', 'rivian',
      ...
      'magna international', 'aptiv', 'borgwarner', 'lear$', 'denso', 'harley davidson', 'polaris industries', 'cars com',
      'autotrader', 'truecar', 'copart', 'manheim',
    ],
    not: ['customer service advisor(s)', 'client service advisor(s)', 'financial service advisor(s)', 'member service advisor(s)',
      'guest service advisor(s)'],
  },
  {
    key: 'agriculture', label: 'Agriculture & Farming', group: 'industry', kind: 'industry',
    words: [
      'agriculture', 'agricultural', 'agribusiness', 'agtech', 'ag tech', 'agronomy', 'agronomist(s)', 'farming', 'farmer(s)', 'farm(s)',
      'farmland', 'farm manager(s)', 'farmworker(s)', 'farm worker(s)', 'ranching', 'rancher(s)', 'cattle', 'livestock', 'poultry',
      'dairy farm(s)', 'dairy farmer(s)', 'aquaculture', 'fishery', 'fisheries', 'horticulture', 'horticulturist(s)', 'viticulture',
      'grower(s)', 'crop science', 'crop production', 'crop protection', 'crop consultant(s)', 'precision agriculture', 'irrigation',
      'hydroponics', 'vertical farming', 'agricultural engineer(s)', 'farm equipment', 'grain elevator(s)', 'fertilizer(s)',
      'feed mill(s)', 'forestry', 'forester(s)',
    ],
    companies: [
      'cargill', 'archer daniels midland', 'bunge$', 'corteva', 'syngenta', 'nutrien', 'cf industries', 'agco$', 'land o lakes',
      'farm credit', 'indigo ag', 'john deere', 'driscolls', 'dole food', 'fresh del monte', 'simplot', 'j r simplot',
      'the mosaic company',
    ],
    // Insurers, banks and the rest named for farms and farmers; farms of servers, wind and trolls.
    not: ['state farm', 'farm bureau', 'farmers insurance', 'farmers mutual', 'farmers bank', 'farmers state bank', 'farmers national bank',
      'farmers savings bank', 'farmers trust', 'farmers merchants', 'farmer mac', 'farmer bros', 'farmer brothers', 'farmers dog',
      'server farm(s)', 'wind farm(s)', 'solar farm(s)', 'content farm(s)', 'link farm(s)', 'click farm(s)', 'troll farm(s)',
      'bot farm(s)', 'farm to table', 'farm team(s)', ...HOBBY],
  },
  ...
  // ── Government, Defense & Aerospace ───────────────────────────────────────
  {
    ...
    companies: [
      ...
      'leidos', 'saic$', 'science applications international', 'booz allen', 'caci', 'mantech', 'parsons$',
  ...
  },
  {
    ...
    words: [
      ...
      'diplomat(s)', 'embassy', 'consulate', 'city planner(s)', 'urban planning', 'public administration', 'federal employee(s)',
      'state employee(s)', 'public works', 'parks and recreation',
    ],
    companies: [
    ...
    // Companies have public policy and government affairs teams of their own.
    not: ['student government', 'city of hope', 'government affairs', 'government relations', 'government sales'],
  },
  ...
  // ── Consulting, Legal & Services ──────────────────────────────────────────
  {
    ...
    companies: [
      ...
      'holland & knight', 'hogan lovells', 'norton rose fulbright', 'clifford chance',
    ...
    // In-house lawyers work for companies in every sector, the police enforce
    // the law, and a seafood chain and an insurer only share the word.
    not: ['law enforcement', 'general counsel', 'in house counsel', 'corporate counsel', 'chief legal officer(s)', 'legal sea foods',
      'legal & general'],
  },
  {
    ...
    companies: [
      ...
      'roland berger', 'l e k consulting', 'lek consulting', 'booz allen hamilton', 'capgemini', 'huron consulting',
  ...
  {
    key: 'security-services', label: 'Security Services', group: 'consulting', kind: 'function',
    // Guards and private security, not cybersecurity (Tech's own sector). Many
    // companies employ their own guards: a company is in security services
    // when it is a security firm.
    words: [
      'security company', 'security companies', 'security firm(s)', 'security services', 'private security', 'security guard company',
      'guard services', 'security patrol', 'executive protection', 'close protection', 'alarm company', 'alarm monitoring',
    ],
    roles: [
      'security guard(s)', 'security officer(s)', 'armed security', 'unarmed security', 'armed guard(s)', 'unarmed guard(s)',
      'bodyguard(s)', 'event security', 'campus security', 'site security', 'security supervisor(s)', 'personal protection',
      'protection agent(s)', 'loss prevention officer(s)',
    ],
    companies: [
      'allied universal', 'securitas', 'gardaworld', 'garda world', 'g4s', 'adt$', 'adt security', 'brinks', 'brinks home', 'pinkerton',
      'prosegur', 'vivint', 'simplisafe', 'us security associates', 'guardsmark',
    ],
    // Security of data, of a country or of an income is another thing.
    not: ['information security', 'cyber security', 'it security', 'data security', 'network security', 'cloud security',
      'application security', 'managed security', 'national security', 'homeland security', 'social security', 'food security',
      'job security', 'financial security', 'security clearance', 'security operations center', 'chief security officer(s)',
      'security token(s)', 'security analyst(s)', 'security engineer(s)', 'security architect(s)', 'security researcher(s)'],
  },
  ...
  },
  {
    ...
    not: ['concrete results', 'under construction', 'brand builder(s)', 'team builder(s)', 'community builder(s)',
      'government contractor(s)', 'defense contractor(s)', 'independent contractor(s)', 'government contracting', 'damage estimator(s)',
      'collision estimator(s)', 'auto estimator(s)'],
  },
  ...
  {
    key: 'social-work', label: 'Social Work & Human Services', group: 'nonprofit', kind: 'industry',
    words: [
      'social work', 'social worker(s)', 'msw', 'bsw', 'lmsw', 'human services', 'social services', 'child welfare',
      'child protective services', 'foster care', 'adoption agency', 'adoption agencies', 'family services', 'youth services',
      'community services', 'case worker(s)', 'caseworker(s)', 'family support', 'homeless services', 'housing assistance',
      'refugee resettlement', 'domestic violence', 'victim advocate(s)', 'victim services', 'youth worker(s)', 'residential counselor(s)',
      'direct support professional(s)', 'group home(s)', 'developmental disabilities', 'intellectual disabilities',
      'reentry services', 'reentry specialist(s)',
    ],
    companies: [
      'catholic charities', 'volunteers of america', 'boys town', 'national association of social workers', 'nasw$',
...
// Bump when how a pick matches changes (this file's code, not its lists, or
// how lib/scoring.js leanToward uses its answers): the version below then
// changes, and scores stamped with it are redone.
// 2: a function sector's roles count in a company's name only.
// 3: a headline part that holds a function sector's role counts no industry
//    sector's words; a broad pick counts a company's one industry only when
//    the curated list or its name gave it, not its people's headlines.
const MATCHING = 3;
...
const FUNCTION = DIRECTORY.map((s) => s.kind === 'function');

// Phrase (words joined by one space) → the sectors it marks.
const WORDS = new Map();
const NAME_WORDS = new Map();
const NOT = new Map();
// A function sector's roles (recruiter, attorney, marketing…) → their sectors:
// a headline part that holds one is about that work.
const ROLES = new Map();
...
DIRECTORY.forEach((s, i) => {
  ...
  if (s.kind === 'function') index(ROLES, s.roles, i);
  index(NOT, s.not, i);
 ...
 * anywhere. `hits` and `vetoes` collect sector indexes, and `roles` (when
 * given) the function sectors whose roles appear before `stop`, except a
 * role inside a longer phrase of the list: "marketing" in "sports marketing"
 * is that phrase's.
 */
function scan(words, stop, withNames, hits, vetoes, roles) {
  const phrases = roles && [];                 // [start, end] of each longer word phrase found
  const found = roles && [];                   // [start, end, sectors] of each role found
  for (let i = 0; i < words.length; i++) {
    ...
    for (let n = 1; ; n++) {
      if (i < stop) {
        ...
        if (w) {
          for (const s of w) hits.add(s);
          if (phrases && n > 1) phrases.push([i, i + n]);
        }
        if (withNames) {
        ...
        if (found) {
          const r = ROLES.get(phrase);
          if (r) found.push([i, i + n, r]);
        }
      }
  ...
  if (!found) return;
  for (const [a, b, sectors] of found) {
    if (phrases.some(([x, y]) => x <= a && b <= y && y - x > b - a)) continue;
    for (const s of sectors) roles.add(s);
  }
}
...
// A company's name followed by one of these is a venue named for it ("State
// Farm Arena", "FedEx Field", "AT&T Performing Arts Center"): its staff aren't
// the company's, so an open-ended entry doesn't claim it.
const VENUE = new Set(['arena', 'stadium', 'center', 'centre', 'field', 'park', 'ballpark', 'dome', 'amphitheater', 'amphitheatre',
  'theater', 'theatre', 'pavilion', 'forum', 'coliseum', 'speedway', 'performing']);
...
function nameSectors(name) {
  ...
  for (const p of PATTERNS.get(words[start]) || []) {
    ...
    if (VENUE.has(words[start + p.words.length])) continue;
    let same = true;
...
function readHeadline(headline, clean) {
  ...
  for (const text of headlineParts(headline)) {
    ...
    const vetoes = new Set();
    const roles = new Set();
    scan(words, stop, false, hits, vetoes, roles);
    // A part that holds a function sector's role ("University Recruiter",
    // "Insurance Defense Attorney", "Dental Marketing Manager") says what the
    // person does, work every kind of company has, so the industry words
    // beside it don't place the company. A role its own sector cancels
    // ("law" in "law enforcement") doesn't count.
    for (const s of roles) {
      if (vetoes.has(s)) continue;
      for (const h of hits) if (!FUNCTION[h]) hits.delete(h);
      break;
    }
 ...
 * Host at The Long Table Podcast" doesn't make Quillon a podcast. The parts
...
// Labels and colours come from lib/sector-labels.js, so a page that only names
// a pick needn't load the word lists; a test keeps the two files the same.
export { sectorByKey, sectorLabel } from './sector-labels.js';
...
/**
 * The broad industry a directory sector sits under ('dental' → 'health'), or
 * nothing for a key that isn't one. Passed to lib/scoring.js readNetwork as
 * `groupOf` beside `sectorsOf`, so a pick of a whole industry includes the
 * companies placed in any of its sectors.
 */
export const sectorGroup = (key) => (INDEX.has(key) ? DIRECTORY[INDEX.get(key)].group : undefined);
 ...
 */
export const DIRECTORY_VERSION = fnv1a(JSON.stringify([MATCHING, [...STOP], [...SCHOOL], [...VENUE], DIRECTORY]));
