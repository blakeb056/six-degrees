...
//              someone's headline as this sector: job titles, credentials,
//              kinds of business. "dentist(s)" means dentist and dentists.
...
export const DIRECTORY = [
  // ── Tech, Software & AI ───────────────────────────────────────────────────
  {
    key: 'software', label: 'Software & SaaS', group: 'tech',
    words: [
      'software', 'saas', 'b2b saas', 'paas', 'iaas', 'software as a service', 'swe', 'sde',
  ...
  {
    key: 'ai-data', label: 'AI & Data', group: 'tech',
    words: [
      ...
      'ai engineer(s)', 'ai engineering', 'ai researcher(s)', 'ai research', 'ai scientist(s)', 'ai lab(s)', 'ai startup(s)', 'ai company',
  ...
  {
    key: 'cybersecurity', label: 'Cybersecurity', group: 'tech',
    words: [
  ...
  {
    key: 'telecom', label: 'Telecom', group: 'tech',
    words: [
  ...
  // ── Finance, VC & Crypto ──────────────────────────────────────────────────
  {
    key: 'fintech', label: 'Fintech & Payments', group: 'finance',
    words: [
  ...
  {
    key: 'banking', label: 'Banking & Lending', group: 'finance',
    words: [
  ...
  {
    key: 'vc-pe', label: 'Venture Capital & Private Equity', group: 'finance',
    words: [
  ...
  {
    key: 'wealth', label: 'Wealth & Asset Management', group: 'finance',
    words: [
  ...
  {
    key: 'insurance', label: 'Insurance', group: 'finance',
    words: [
  ...
  {
    key: 'accounting', label: 'Accounting & Tax', group: 'finance',
    words: [
      'accounting', 'accountant(s)', 'cpa', 'cpas', 'certified public accountant(s)', 'chartered accountant(s)', 'acca', 'tax',
      'tax preparer(s)', 'tax preparation', 'tax advisor(s)', 'enrolled agent(s)', 'bookkeeper(s)', 'bookkeeping', 'auditor(s)',
      'external audit', 'internal audit', 'audit & assurance', 'accounts payable', 'accounts receivable', 'financial controller(s)',
      'corporate controller(s)', 'fractional cfo(s)', 'forensic accounting', 'forensic accountant(s)', 'quickbooks', 'big four', 'big 4',
    ],
    companies: [
  ...
  {
    key: 'crypto', label: 'Crypto & Web3', group: 'finance',
    words: [
  ...
  // ── Healthcare & Biotech ──────────────────────────────────────────────────
  {
    key: 'hospitals', label: 'Hospitals & Clinics', group: 'health',
    words: [
  ...
  {
    key: 'dental', label: 'Dental', group: 'health',
    words: [
  ...
  {
    key: 'pharma-biotech', label: 'Pharma & Biotech', group: 'health',
    words: [
  ...
  {
    key: 'medical-devices', label: 'Medical Devices', group: 'health',
    words: [
  ...
  {
    key: 'mental-health', label: 'Mental Health', group: 'health',
    words: [
  ...
  {
    key: 'fitness-wellness', label: 'Fitness & Wellness', group: 'health',
    words: [
  ...
  // ── Education ─────────────────────────────────────────────────────────────
  {
    key: 'k12', label: 'K-12 Education', group: 'education',
    words: [
  ...
  {
    key: 'higher-ed', label: 'Higher Education', group: 'education',
    words: [
  ...
  {
    key: 'marketing-advertising', label: 'Marketing & Advertising', group: 'media',
    words: [
      'marketing', 'marketer(s)', 'advertising', 'ad agency', 'ad agencies', 'digital agency', 'creative agency', 'creative agencies',
      'marketing agency', 'marketing agencies', 'media agency', 'branding', 'brand strategy', 'brand strategist(s)', 'brand manager(s)',
      ...
      'demand gen', 'lifecycle marketing', 'product marketing', 'marketing operations', 'marketing ops', 'martech', 'adtech', 'ad tech',
      'media buyer(s)', 'media buying', 'media planner(s)', 'media planning', 'programmatic', 'ad operations', 'ad ops', 'market research',
    ],
    companies: [
  ...
  {
    key: 'pr-comms', label: 'PR & Communications', group: 'media',
    words: [
      'public relations', 'pr agency', 'pr agencies', 'pr firm(s)', 'pr manager(s)', 'pr director(s)', 'pr specialist(s)', 'pr lead',
  ...
  {
    key: 'media-publishing', label: 'Media & Publishing', group: 'media',
    words: [
  ...
  {
    key: 'creator-economy', label: 'Creator Economy', group: 'media',
    words: [
  ...
  {
    key: 'film-tv-music', label: 'Film, TV & Music', group: 'entertainment',
    words: [
  ...
  {
    key: 'gaming-esports', label: 'Gaming & Esports', group: 'entertainment',
    words: [
  ...
  {
    key: 'sports', label: 'Sports', group: 'entertainment',
    words: [
  ...
  {
    key: 'ecommerce-retail', label: 'E-commerce & Retail', group: 'consumer',
    words: [
  ...
  {
    key: 'consumer-goods', label: 'Consumer Goods', group: 'consumer',
    words: [
  ...
  {
    key: 'restaurants', label: 'Restaurants & Food Service', group: 'consumer',
    words: [
  ...
  {
    key: 'hospitality-travel', label: 'Hospitality & Travel', group: 'consumer',
    words: [
  ...
  {
    key: 'logistics', label: 'Logistics & Supply Chain', group: 'industry',
    words: [
  ...
  {
    key: 'manufacturing', label: 'Manufacturing', group: 'industry',
    words: [
  ...
  {
    key: 'energy', label: 'Energy & Utilities', group: 'industry',
    words: [
  ...
  {
    key: 'automotive', label: 'Automotive', group: 'industry',
    words: [
  ...
  {
    key: 'aerospace-defense', label: 'Aerospace & Defense', group: 'defense',
    words: [
  ...
  {
    key: 'military', label: 'Military', group: 'defense',
    words: [
  ...
  {
    key: 'government', label: 'Government & Public Sector', group: 'defense',
    words: [
  ...
  {
    key: 'legal', label: 'Legal', group: 'consulting',
    words: [
      'law', 'lawyer(s)', 'attorney(s)', 'attorney at law', 'attorneys at law', 'law firm(s)', 'law office(s)', 'law group', 'legal',
      'legal services', 'esq', 'esquire', 'paralegal(s)', 'legal assistant(s)', 'legal secretary', 'litigator(s)', 'litigation',
      'counsel', 'of counsel', 'legal counsel', 'associate attorney(s)', 'juris doctor', 'jd candidate(s)', 'law student(s)',
      'law clerk(s)', 'judicial clerk(s)', 'circuit judge(s)', 'district judge(s)', 'federal judge(s)', 'magistrate(s)',
      'district attorney(s)', 'public defender(s)', 'prosecutor(s)', 'legaltech', 'legal tech', 'e discovery', 'ediscovery',
      'intellectual property', 'patent attorney(s)', 'patent agent(s)', 'bar association', 'notary public', 'mediator(s)',
      'arbitrator(s)', 'arbitration',
    ],
    companies: [
  ...
  {
    key: 'management-consulting', label: 'Management Consulting', group: 'consulting',
    words: [
      'management consulting', 'management consultant(s)', 'strategy consulting', 'strategy consultant(s)', 'business consulting',
      'operations consulting', 'mbb', 'big four', 'big 4',
    ],
    companies: [
  ...
  {
    key: 'hr-recruiting', label: 'HR & Recruiting', group: 'consulting',
    words: [
      ...
      'headhunter(s)', 'executive search', 'staffing', 'staffing agency', 'staffing firm(s)', 'recruitment agency', 'recruiting firm(s)',
      'talent sourcing', 'sourcer(s)', 'employer branding', 'compensation and benefits', 'total rewards', 'benefits administration',
      'payroll', 'peo', 'professional employer organization', 'workforce solutions', 'hr tech', 'hrtech', 'hr consultant(s)',
      'hr consulting', 'shrm', 'shrm cp', 'shrm scp', 'sphr', 'phr', 'learning and development', 'l&d', 'organizational development',
      'dei', 'diversity equity and inclusion', 'employee relations', 'labor relations', 'rpo',
    ],
    companies: [
  ...
  {
    key: 'real-estate', label: 'Real Estate', group: 'realestate',
    words: [
  ...
  {
    key: 'construction-trades', label: 'Construction & Trades', group: 'realestate',
    words: [
  ...
  // ── Nonprofit & Community ─────────────────────────────────────────────────
  {
    key: 'charities', label: 'Nonprofits & Charities', group: 'nonprofit',
    words: [
  ...
  {
    key: 'faith', label: 'Faith & Ministry', group: 'nonprofit',
    words: [
 ...
 *   - its name has one of the sector's words (or names), or is one of its
 *     companies, or
 ...
 *     (sectorsAt). For a one-person company, that person decides.
...
const BY_KEY = new Map([
  ...
  ...DIRECTORY.map((s) => [s.key, Object.freeze({
    key: s.key, label: s.label, color: GROUP.get(s.group)?.color || UNKNOWN_INDUSTRY.color, group: s.group, kind: 'sector',
  })]),
]);

/** A pick's label and colour, for a broad industry or a directory sector. */
...
for (const s of DIRECTORY) {
  for (const list of [s.words, s.names, s.companies, s.not]) if (list) Object.freeze(list);
  Object.freeze(s);
}
