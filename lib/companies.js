...
// ("UCF", "Snap", "Lens" and "AR" were, and "AR Specialist" is accounts
// receivable). Editing them changes the stored scores' list stamp (lib/rpc.js),
...
export const INDUSTRIES = [
  ...
  { key: 'media', label: 'Marketing, Media & Creator', color: '#e67e22',
    words: /\b(marketing|brand|branding|advertising|agency|media|content|social media|creative|creator|influencer|pr|public relations|communications|tiktok|pinterest|youtube|growth)\b/i },
