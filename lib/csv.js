...
// Prestige ladder for CSV imports. Deliberately a REDUCED model compared with
// scripts/score_new_connections.sql: LinkedIn's export carries a bare job title
// and no headline, so the headline-signal bonus and the recency bonus cannot be
// computed and are not applied. Scores here therefore come from role and
// company alone, and can differ by a tier from the same person scraped. Scoring
// happens at import because an unscored record renders as "NaN" across the UI.
