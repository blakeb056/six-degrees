...
// The word lists the stored scores were computed with: a fingerprint of every
// entry on the curated company list (name, score, alias, industry) and of the
// broad industries' words (lib/companies.js INDUSTRIES), stamped beside them
// in app_meta 'scoring_list'. The words decide a company's one industry, which
// decides whether it is a school (no estimate) and whether a broad pick in
// Settings leans it. Editing either makes stored scores stale, as a new
