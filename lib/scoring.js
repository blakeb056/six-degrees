...
//                        medal…). Halved at a company scored 4 or less,
//                        judged before any sector lean.
...
// against the text as written: lowercase "uf" is a word, "UF" a name.
...
// ("UCF Marketing Club", "NYU Finance Society"), or an association named for
...
/** Can this short name ("UCF", "UBS") be a school's? Not one on NOT_A_SCHOOL, nor a company the curated list knows. */
...
// Until September 2026 this named four awards (Cannes Lions, the Emmys, the
// Grammys and the Webbys), so a Pulitzer or an Olympic medal earned nothing.
const HONOURS = [
...
export const RULE_TABLES = {
  ...
  junkCompany: JUNK_COMPANY, notACompany: NOT_A_COMPANY, schoolName: SCHOOL_NAME, notItsStaff: NOT_ITS_STAFF,
  platformRole: PLATFORM_ROLE, platforms: PLATFORMS, bonuses: BONUSES,
};
